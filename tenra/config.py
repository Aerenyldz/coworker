...
3. Dosya veya proje içeriğini görmek için 'file' aracını (action='read' veya action='list') veya gerekirse 'shell' aracını KULLAN.
4. Dosya işlemleri ve terminal komutları varsayılan olarak AKTİF ÇALIŞMA ALANI ({target_ws}) içinde icra edilir. Bağıl yollar doğrudan bu proje dizinine göre çözülür.
